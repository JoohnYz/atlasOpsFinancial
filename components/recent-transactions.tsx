            ...
            <div className="space-y-3">
              {transactions.slice(0, 6).map((transaction, index) => (
                <div
                  ...
                  className="flex items-center justify-between p-4 rounded-xl bg-secondary/30 hover:bg-secondary/60 transition-all duration-200 border border-border hover:border-muted-foreground/20 cursor-pointer group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-foreground font-sans group-hover:text-primary transition-colors">{transaction.description}</p>
